...
struct nsTArray_SafeElementAtHelper<nsCOMPtr<E>, Derived, Alloc>
    : public nsTArray_SafeElementAtSmartPtrHelper<E, Derived, Alloc> {};
...
class nsTArray_Impl
    : public nsTArray_base<Alloc,
      ...
      public nsTArray_TypedBase<E, nsTArray_Impl<E, Alloc>, Alloc> {
 private:
 ...
 public:
  ...
  explicit nsTArray_Impl(const self_type& aOther) { ApndMyElems(aOther); }
 ...
 protected:
  ...
  elem_type* ApndMyElems(const nsTArray_Impl<Item, Allocator>& aArray) {
