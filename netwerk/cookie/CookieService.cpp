...
// static
already_AddRefed<nsICookieSettings> CookieService::GetCookieSettings(
    nsIChannel* aChannel) {
...
bool CookieService::ParseAttributes(nsCString& aCookieHeader,
                                    CookieStruct& aCookieData,
...
CookieStatus CookieService::CheckPrefs(nsICookieSettings* aCookieSettings,
...
bool CookieService::CheckPath(CookieStruct& aCookieData, nsIURI* aHostURI) {
