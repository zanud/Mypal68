...
A lot of code in DevTools is asynchronous, because a lot of it relies on connecting to the DevTools devtools server and getting information from there in an asynchronous fashion.
